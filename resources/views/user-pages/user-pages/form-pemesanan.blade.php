                ...
                <div class="space-y-4 border border-gray-200 rounded-lg p-6 bg-gray-50">
                    ...
                    <div class="flex items-center gap-6">
                        <label class="flex items-center gap-2">
                            <input type="radio" name="pemesan_gender" value="L" required class="accent-blue-600">
                            <span>Tuan</span>
                        </label>
                        <label class="flex items-center gap-2">
                            <input type="radio" name="pemesan_gender" value="P" required class="accent-pink-500">
                            <span>Nyonya</span>
                        </label>
                    </div>
