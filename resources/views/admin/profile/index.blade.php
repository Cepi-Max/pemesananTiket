            ...
            <form  method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control @error('visi') is-invalid @enderror" id="visi" name="visi" rows="5" placeholder="Masukkan Visi">{{ old('visi', $AboutUs->visi ?? '') }}</textarea>
                        @error('visi')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control @error('misi') is-invalid @enderror" id="misi" name="misi" rows="5" placeholder="Masukkan Misi">{{ old('misi', $AboutUs->misi ?? '') }}</textarea>
                        @error('misi')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
